...
/**
 * SPRINT 35 — Unified button system.
 * One radius (control 14), one height scale (32 / 40 / 48),
 * one hover language, one pressed state, one icon size (16px).
 */
const buttonVariants = cva(
  [
    "inline-flex items-center justify-center gap-2 whitespace-nowrap select-none",
    "rounded-control font-medium tracking-[-0.006em]",
  ...
  ].join(" "),
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border bg-transparent hover:bg-muted/60 hover:border-border text-foreground",
