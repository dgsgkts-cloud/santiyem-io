...
import {
  ...
  extractPriorProject,
} from "./intents/classifyIntent.ts";
...
// classifyIntentHeuristic / extractPriorProject live in
// ./intents/classifyIntent.ts (Sprint 8.1 Phase 4 partial).
// SYSTEM_PROMPT is imported from ./prompt/systemPrompt.ts.
// ============================================================
...
10. Rakam veya tarih uydurma. Bilinmeyeni her zaman sor.`;
    ...
    // ============================================================
    if (voiceMode) {
      // Voice: use a lean system prompt (imported from ./prompt/voicePrompt.ts,
      // Sprint 8.1) and pass only text messages — no attachments, no markdown scaffolding.
      const voiceSystem = VOICE_SYSTEM_PROMPT + projectDataContext;
